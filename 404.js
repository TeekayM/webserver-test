...
! function(t) {
    ...
    window.tram = function(t) {
        ...
        var I = e.frame = function() { var t = p.requestAnimationFrame || p.webkitRequestAnimationFrame || p.mozRequestAnimationFrame || p.oRequestAnimationFrame || p.msRequestAnimationFrame; return t && R.bind ? t.bind(p) : function(t) { p.setTimeout(t, 16) } }(),
            D = e.now = function() {
                var t = p.performance,
            ...
            F = l(N, function(t, e) { t.init = function() { e.init.apply(this, arguments), this.original || (this.original = this.convert(this.get(), b)) } }),
            $ = l(N, function(t, e) { t.init = function() { e.init.apply(this, arguments), this.animate = this.fallback }, t.get = function() { return this.$el[this.name]() }, t.update = function(t) { this.$el[this.name](t) } }),
            q = l(N, function(t, e) {
        ...
        var G = t.style,
            ...
            Y = { color: [F, b], background: [F, b, "background-color"], "outline-color": [F, b], "border-color": [F, b], "border-top-color": [F, b], "border-right-color": [F, b], "border-bottom-color": [F, b], "border-left-color": [F, b], "border-width": [N, y], "border-top-width": [N, y], "border-right-width": [N, y], "border-bottom-width": [N, y], "border-left-width": [N, y], "border-spacing": [N, y], "letter-spacing": [N, y], margin: [N, y], "margin-top": [N, y], "margin-right": [N, y], "margin-bottom": [N, y], "margin-left": [N, y], padding: [N, y], "padding-top": [N, y], "padding-right": [N, y], "padding-bottom": [N, y], "padding-left": [N, y], "outline-width": [N, y], opacity: [N, g], top: [N, x], right: [N, x], bottom: [N, x], left: [N, x], "font-size": [N, x], "text-indent": [N, x], "word-spacing": [N, x], width: [N, x], "min-width": [N, x], "max-width": [N, x], height: [N, x], "min-height": [N, x], "max-height": [N, x], "line-height": [N, _], "scroll-top": [$, g, "scrollTop"], "scroll-left": [$, g, "scrollLeft"] },
            Z = {};
...
}, function(t, e) { t.exports = function(t) { return t && t.__esModule ? t : { default: t } } }, function(t, e, n) { n(4), n(7), n(8), n(9), n(10), n(11), n(12), t.exports = n(17) }, function(t, e, n) {
    "use strict";
    var i = n(0);
    ...
    r.define("forms", t.exports = function(t, e) {
        ...
        function y(e, n) {
            ...
            r.handler = null, r.redirect = i.attr("data-redirect"), g.test(c) ? r.handler = A : c || (o ? r.handler = O : b())
        }
    ...
    i.define("navbar", t.exports = function(t, e) {
        ...
        function A(n, i) {
            ...
            c && "/" === c.attr("href") && null == c.attr("aria-label") && c.attr("aria-label", "home"), a.button.attr("style", "-webkit-user-select: text;"), null == a.button.attr("aria-label") && a.button.attr("aria-label", "menu"), a.button.attr("role", "button"), a.button.attr("tabindex", "0"), a.button.attr("aria-controls", a.overlayContainerId), a.button.attr("aria-haspopup", "menu"), a.button.attr("aria-expanded", "false"), a.el.off(m), a.button.off(m), a.menu.off(m), C(a), s ? (T(a), a.el.on("setting" + m, function(t) {
                return function(n, i) {
                    i = i || {};
                    var r = f.width();
                    C(t), !0 === i.open && F(t, !0), !1 === i.open && q(t, !0), t.open && e.defer(function() { r !== f.width() && R(t) })
                }
            }(a))) : (! function(e) {
                if (e.overlay) return;
        ...
        function R(t) { t.open && (q(t, !0), F(t, !0)) }

        function z(t) { return h(function() { t.open ? q(t) : F(t) }) }
        ...
        }, c.destroy = function() { _ = t(), E(), a && a.length && a.each(L) };
